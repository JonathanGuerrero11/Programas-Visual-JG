...
namespace Actividad_3_Problema_9
{
    class Actividad_3_Problema_9
    {
        ...
        public void datos()
        {
            do
            {
                ...
                Console.WriteLine(" ");
                Console.WriteLine("¿Quiere salir del programa en cuestion? (S/N)");
        ...
        static void Main(string[] args)
        {
            ...
            Actividad_3_Problema_9 sc = new Actividad_3_Problema_9();
            sc.datos();
